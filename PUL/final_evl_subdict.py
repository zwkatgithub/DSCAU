...
if __name__ == "__main__":
    ...
    parser.add_argument("--ens", dest="ens", default="none")
    parser.add_argument("--suf", dest="suf", default="bond")
    ...
    if args.nonmisc==0:
        ...
        filenames = [
            args.result_dir+"/"+args.type+"_"+args.ens+"_feature_pu_"+args.dataset+"_{}.txt".format(flag) 
                for flag in types
        ]
    else:
    ...
    origin_file = "data_{}/".format(args.suf) + args.dataset + "/{}".format("test.txt")
